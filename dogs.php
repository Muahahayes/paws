...
<html>
    ...
    <body id="dog">
            ...
            if(isset($_SESSION["name"])){ //In final release will have user log-in for sessions and will set the name value
                if($_SESSION["name"] == "admin"){ //vets will share an admin account, so if that account's name is on the session cookie show admin pages
                    ...
                    <ul class="navbar-nav">
                        ...
                        <li class="nav-item active"><a class="nav-link" href="dogs.php">Dogs</a></li>
        ...
        <br><br>
        <div class="container">
            <div class="d-flex justify-content-center"><h2>Dogs</h1></div>
            ...
            <?php 
                if($page > 1){
                    ...
                    <div class="d-flex flex-row">
                        <button class="btn btn-primary" style="font-size:18pt" onclick="location.href=\'dogs.php?p=' . ($page - 1) . '\'" type="button">←</button>
                        <span style="padding: 10px; font-size:18pt"> ' . $page . ' </span>
                        <button id="forward" class="btn btn-primary" style="font-size:18pt" onclick="location.href=\'dogs.php?p=' . ($page + 1) . '\'" type="button">→</button>                    
                    </div>
                    ');
                }
                else{
